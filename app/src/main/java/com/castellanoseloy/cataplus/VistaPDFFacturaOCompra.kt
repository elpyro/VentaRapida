...
import com.castellanoseloy.cataplus.procesos.crearPdf.CrearPdfFacturaOCompra
...
import com.castellanoseloy.cataplus.procesos.crearPdf.CrearPdfReciboIngreso
...
class VistaPDFFacturaOCompra : AppCompatActivity() {
    ...
    private fun compartirPDF() {
        ...
        val uri = FileProvider.getUriForFile(this, "com.castellanoseloy.cataplus.fileprovider", file)
